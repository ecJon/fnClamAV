...
| 日期 | 版本 | 变更内容 | 作者 |
|------|------|----------|------|
| 2026-02-13 | 1.0 | 补充 FFI 相关缺失设计：新增扫描任务队列设计、引擎异常恢复设计；更新 API 接口（添加 pause/resume）；更新错误码；修复重复架构图问题 | Claude |
| 2026-02-13 | 0.9 | ClamAV 集成方案改为 FFI 动态库调用：更新方案选择、文件布局、扫描流程、扫描控制、进度反馈设计；更新架构图；新增引擎生命周期管理设计 | Claude |
